...
function cards() {
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://127.0.0.1:3000/menu')
        .then(data => {
    ...
    // getResource('http://127.0.0.1:3000/menu')
...
function forms(formSelector, modalTimerId) {
   ...
   function bindPostData(form) { //ф-я постинга данных
       form.addEventListener('submit', (e) => {
           ...
           (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://127.0.0.1:3000/requests', json)
           .then(data => {
               console.log(data);
   ...
   function showThanksModal(message) {
       ...
       setTimeout(() => {
           ...
           (0,_modal__WEBPACK_IMPORTED_MODULE_0__.closeMod)('.modal');
       }, 4000);
   }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "closeMod": () => (/* binding */ closeMod),
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({container, slide, netxArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    const slides = document.querySelectorAll(slide),
          ...
          next = document.querySelector(netxArrow),
...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 55000);
